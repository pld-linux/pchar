...
Summary(pl):	Pchar: Narzêdzie do okre¶lania charakterystyk ³±cz Internetu
Name:		pchar
Version:	1.2
Release:	1
License:	GPL
...
%description -l pl
Pchar jest reimplementacj± programu pathchar napisanego przez Van Jacobsona
z Lawrence Berkeley Laboratories. Pozwala na okre¶lenie charakterystyk
przepustowo¶ci, opó¼nienia i strat pakietów na ³±czach poprzez Internet.
